...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'A named user or assistant article. Responses are plain text, not Markdown. Sources remain visible; failure and interruption are separate states. The panel provides transition announcements and restores focus before Retry removes its control.',
      },
    },
  },
  args: {
...
export const Error: Story = { args: { message: errorMessage } };
export const Interrupted: Story = {
  args: {
    message: { ...sampleMessages[1], citations: undefined, interrupted: true },
  },
};
